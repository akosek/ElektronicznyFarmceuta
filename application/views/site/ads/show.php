...
<label for="inputEmail3" class="col-sm-2 control-label">Twój Email</label>
<div class="col-sm-4">
...
<div class="form-group">
<label for="inputEmail3" class="col-sm-2 control-label">Temat</label>
<div class="col-sm-4">
...
<div class="form-group">
<label for="inputEmail3" class="col-sm-2 control-label">Wiadomość</label>
<div class="col-sm-4">
